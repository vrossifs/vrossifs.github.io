    ...
    return (
      <header className="header">
        ...
        <div className="ps-header--center header--mobile">
          <div className="container">
            <div className="header-inner">
              ...
              <div className="header-inner__center"><a className="logo open" href={window.location.origin}>Farm<span className="text-black">art.</span></a></div>
        ...
        <section className="ps-header--center header-desktop">
          <div className="container">
            <div className="header-inner">
              <div className="header-inner__left"><a className="logo" href={window.location.origin}>Farm<span className="text-black">art.</span></a>
                <ul className="menu">
